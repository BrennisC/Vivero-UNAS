...

{
    ...
    case WM_DESTROY:
        ...
        break;
    case WM_CREATE:
        boton1 = CreateWindowEx(0, "button", "REGISTRO", WS_VISIBLE | WS_CHILD | 0, 20, 0, 80, 25, ventana1, (HMENU)bt1, 0, 0);
        boton2 = CreateWindowEx(0, "button", "MOSTRAR", WS_VISIBLE | WS_CHILD | 0, 20, 30, 80, 25, ventana1, (HMENU)bt2, 0, 0);
    /* case WM_COMMAND:
